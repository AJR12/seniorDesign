...
from IMayFunctions import *


class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        MainWindow.setObjectName("IMay")
        ...
        self.Debug_1.clicked.connect(lambda: rename())
        self.Debug_2.clicked.connect(lambda: zip_files())
        self.Debug_3.pressed.connect(lambda: self.file_dialog())

    def retranslateUi(self, MainWindow):
        _translate = QtCore.QCoreApplication.translate
        MainWindow.setWindowTitle(_translate("MainWindow", "IMay_Prototype"))
